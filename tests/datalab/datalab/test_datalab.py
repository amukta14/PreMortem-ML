...
from premortemml.datalab.internal.issue_manager.knn_graph_helpers import num_neighbors_in_knn_graph
...
class TestDatalab:
    ...
    def test_failed_issue_managers(self, lab, monkeypatch, list_possible_issue_types):
        ...
        monkeypatch.setattr(
            "premortemml.datalab.internal.issue_finder._IssueManagerFactory", MockIssueManagerFactory
        )
    ...
    def test_report(self, lab, monkeypatch, capsys):
        ...
        monkeypatch.setattr(premortemml.datalab.internal.helper_factory, "Reporter", MockReporter)
        monkeypatch.setattr(
            lab.data_issues,
            "issue_summary",
...
class TestDatalabIssueManagerInteraction:
    ...
    def test_custom_issue_manager_not_registered(self, lab):
        ...
        with patch("premortemml.datalab.internal.issue_manager_factory.REGISTRY", mock_registry):
            with pytest.raises(ValueError) as excinfo:
    ...
    def test_custom_issue_manager_registered(self, lab, custom_issue_manager):
        ...
        from premortemml.datalab.internal.issue_manager_factory import register
    ...
    def test_find_issues_for_custom_issue_manager_with_custom_kwarg(
        ...
        # Clean up registry
        from premortemml.datalab.internal.issue_manager_factory import REGISTRY
