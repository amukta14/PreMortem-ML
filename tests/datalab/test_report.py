...
class TestReporter:
    ...
    def test_get_report(self, reporter, data_issues, include_description, monkeypatch):
        ...
        monkeypatch.setattr(
            "premortemml.datalab.internal.report._IssueManagerFactory", MockIssueManagerFactory
        )
    ...
    def test_summary_with_score(self, reporter, data_issues, monkeypatch):
        ...
        expected_output = (
            ...
            + "Learn about each issue: https://docs.premortemml.ai/stable/premortemml/datalab/guide/issue_type_description.html\n"
