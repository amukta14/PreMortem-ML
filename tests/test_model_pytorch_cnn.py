...
from premortemml.experimental.mnist_pytorch import (
    CNN,
...
def test_loaders(
    ...
    from premortemml.count import estimate_confident_joint_and_cv_pred_proba, estimate_latent
    ...
    for loader in ["train", "test", None]:
        ...
        # This next block of code checks if premortemml works with the CNN
        ...
        err_idx = premortemml.filter.find_label_issues(
