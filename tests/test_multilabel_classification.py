...
from premortemml import multilabel_classification as ml_classification
from premortemml.internal import multilabel_scorer as ml_scorer
from premortemml.internal.multilabel_utils import get_onehot_num_classes, onehot2int, stack_complement
from premortemml.multilabel_classification import filter
from premortemml.multilabel_classification.dataset import (
    common_multilabel_issues,
    multilabel_health_summary,
    overall_multilabel_health_score,
    rank_classes_by_multilabel_quality,
)
from premortemml.multilabel_classification.rank import get_label_quality_scores_per_class
...
@composite
def premortemml_data_strategy(draw):
...
class TestMultiLabel:
    @given(premortemml_data_strategy())
