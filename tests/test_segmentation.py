"""
Scripts to test premortemml.segmentation package
"""
...
# Segmentation utils
from premortemml.internal.segmentation_utils import (
    _check_input,
...
# Filter
from premortemml.segmentation.filter import (
    find_label_issues,
)

# Rank
from premortemml.segmentation.rank import (
...
# Summary
from premortemml.segmentation.summary import (
    display_issues,
    common_label_issues,
    filter_by_class,
    _generate_colormap,
...
def test__get_label_quality_per_image():
    ...
    premortemml_softmin = softmin(
        np.expand_dims(random_score_array, axis=0), axis=1, temperature=temp
    )[0]
    assert premortemml_softmin == score, "Expected premortemml_softmin to be equal to score"
