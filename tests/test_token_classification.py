from premortemml.internal.token_classification_utils import (
    get_sentence,
    filter_sentence,
    process_token,
    mapping,
...
from premortemml.token_classification.filter import find_label_issues
from premortemml.token_classification.rank import (
    get_label_quality_scores,
    issues_from_scores,
    _softmin_sentence_score,
)
from premortemml.token_classification.summary import (
    display_issues,
    common_label_issues,
    filter_by_token,
)
...
words = [["Hello", "World"], ["#I", "love", "PreMortemML"], ["A"]]
sentences = ["Hello World", "#I love PreMortemML", "A"]
...
def test_filter_sentence():
    ...
    assert filtered_sentences == ["Hello World", "#I love PreMortemML"]
...
def test_process_token():
    test_cases = [
        ("PreMortemML", [("C", "a")], "aleanlab"),
        ("PreMortemML", [("C", "a"), ("a", "C")], "aleCnlCb"),
    ]
